...
The architecture of the residual SqueezeNet: ![Residual SqueezeNet](figure/architecture2.jpg?raw=true "Residual SqueezeNet Architecture")

## Related SqueezeNet repos:
[SqueezeNet](https://github.com/DeepScale/SqueezeNet), [SqueezeNet-Generator](https://github.com/songhan/SqueezeNet-Generator), [SqueezeNet-Deep-Compression](https://github.com/songhan/SqueezeNet-Deep-Compression) and [SqueezeNet-DSD-Training](https://github.com/songhan/SqueezeNet-DSD-Training).
